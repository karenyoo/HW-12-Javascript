...
submit.on("click", function() {
    ...
    var inputElementDuration = iinputElementDuration.property("value");
    ...
    if(filteredData === undefined || filteredData.length == 0) {
        d3.select("span").text("No UFO sightings for the filter(s) you entered. Please try again.").style("font-size", "16px");
    }
    else {
